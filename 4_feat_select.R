print('4.1 - feature selection underway')
set.seed(0)
...
png("hist_p_vals.png",width=3000, height = 3000,units='px',res=300)
layout(matrix(c(1,2,3,3), 2, 2, byrow = TRUE))
#par(mar=c(0,0,0,0))
hist(p_vals,breaks=50,main='All P-Values',xlab='P-Values')
hist(p_vals[p_vals<0.005],breaks=50,xlab='P-Values',ylab='',main='P-Vals < 5e-03')
plot(2:17309,sort(p_vals),type='l',main='Sorted P-values',xlab='index',lwd=2)
dev.off()


#==============================================================================#
#### CORRELATION FOR FEATURE REMOVAL ####
print('4.2 - Finding correlation')
...
print('4.3 - Reduce df to df_sml; a feature reduced dataframe')
